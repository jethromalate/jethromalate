  ...
  <div class="container">
    <section class="home">
      <div class="max-width content">
        ...
        <div class="links">
          <a href="https://github.com/jethromalate">
            <i class="bx bxl-github social"></i>
          </a>
          <a href="https://www.linkedin.com/in/jethromalate/">
...
.name {
  @apply block font-semibold text-7xl ml-8;
  letter-spacing: 1px;
}
...
@media (max-width: 947px) {
  .introduction {
    @apply block text-2xl ml-8;
  }

  .name {
    @apply block font-semibold text-5xl ml-8;
    letter-spacing: 1px;
  }
